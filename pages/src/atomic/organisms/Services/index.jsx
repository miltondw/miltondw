  ...
  return (
    <section id="services">
      ...
      <div className="container services__container">
        <CardServices title={"Consultoría Tecnológica"} items={itemsTech} />
        <CardServices title={"Creación de sitio Web"} items={itemsWeb} />
        <CardServices title={"Desarrollo de Tienda Online"} items={itemsShop} />
      </div>
    </section>
  );
}
